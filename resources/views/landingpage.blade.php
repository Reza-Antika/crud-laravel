            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                @if (Route::has('login'))
                    <div class="d-lg-flex align-items-center d-none ms-auto">
                        ...
                        <a class="custom-btn btn" style="color:white" href="/dashboard">
                            Dashboard
                        </a>
                        @else
                        <i class="navbar-icon bi-telephone-plus me-3"></i>
                        <a class="custom-btn btn" style="color:white" href="/login">
                            Login
                        </a>
                        @endauth
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                          <div class="hero-image" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <img src="img/wfh.jpg" class="img-fluid" alt="working girl" style="border-radius: 100%">
                          </div>
                        </div>
               ...
               <div class="row">
                    ...
                    <div class="col-lg-7 mx-auto col-md-10 col-12">
                         ...
                         <div class="about-image" data-aos="fade-up" data-aos-delay="200">
                          ...
                          <img src="img/work.jpg" class="img-fluid" alt="office">
                        </div>
                    </div>
                        ...
                        <h2 class="mb-5 text-center" data-aos="fade-up">
                         ...
                         <div class="owl-carousel owl-theme" id="project-slide">
                              <div class="item project-wrapper" data-aos="fade-up" data-aos-delay="100">
                                   <img src="img/laptop.jpg" class="img-fluid" alt="project image">
               ...
               <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <div class="contact-image" data-aos="fade-up">
                          ...
                          <img src="img/wfh.jpg" class="img-fluid" alt="website">
                        </div>
                    </div>
